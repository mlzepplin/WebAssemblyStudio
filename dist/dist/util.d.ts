...
export declare function readUploadedDirectory(inputEntry: any, root: Directory): Promise<void>;
export declare function uploadFilesToDirectory(items: DataTransferItemList, root: Directory): Promise<void>;
